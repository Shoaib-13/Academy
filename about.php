        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">About
                    <small>Academy of Computer Application Learning</small>
                </h1>
                <ol class="breadcrumb">
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <ul class="list-inline">
                            ...
                            <li><a href="https://www.linkedin.com/profile/view"><i class="fa fa-2x fa-linkedin-square"></i></a>
                            </li>
                            <li><a href="https://twitter.com/login"><i class="fa fa-2x fa-twitter-square"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
