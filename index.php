...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		...
		<div class="item">
			...
			<div class="carousel-caption">
				<h2 style="color: orange">Feed your Brain With Knowledge</h2>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('images/1900x10803.png');"></div>
			<div class="carousel-caption">
				<a href="takeexam"><h2 style="color: blue; ">Take Exam</h2>
                </div>
            </div>
        </div>
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
            	Welcome to Academy of Computer Application Learning
            </h1>
		</div>
		<div class="col-md-4">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Academy of Computer Application Learning</h2>
		</div>
		<div class="col-md-6">
			<p>Academy of Computer Application Learning by <strong>MD. Shoaib 03790202017 & Akshay 00590202017</strong> includes:</p>
			<ul>
				<li>Bootstrap v3.3.7
				</li>
